...
// import { startAcceptOrder, startRejectOrder } from '../../../actions/driverAction'
...
//     <Card style={{width:"80rem",height:"320px"} }>
//     <Row>
//         <Col md={6}>
...
//             <div>
// <Card.Text><strong>Payment Status:</strong> {myOrder.paymentStatus ? 'Paid' : 'Pending'}</Card.Text>            </div>
//           )}
...
//             <div>
//               <Button onClick={()=>handleAccept(myOrder._id)}>Accept Trip</Button>
//               <Button onClick={()=>{handleReject(myOrder._id)}}>Reject Trip</Button>
//             </div>
//           )}
...
import { startAcceptOrder, startRejectOrder,startTrip ,startTripOtpVerify} from '../../../actions/driverAction';
